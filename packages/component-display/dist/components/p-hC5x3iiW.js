...
const slotsTabCss = ":host{display:block}";

const SlotsTab = /*@__PURE__*/ proxyCustomElement(class SlotsTab extends H {
    constructor() {
        super();
        this.__registerHost();
        this.slotValueChange = createEvent(this, "slotValueChange");
     ...
     */
    emitSlotEvent(e) {
        const sanitizedValue = purify.sanitize(e.target.value, {
    ...
    static get style() { return slotsTabCss; }
}, [0, "slots-tab", {
        "slotObject": [16, "slot-object"],
        "displayElement": [16, "display-element"],
        "slotHistory": [16, "slot-history"],
        "lang": [32],
        "slotErrors": [32],
...
function defineCustomElement() {
    ...
    const components = ["slots-tab"];
    components.forEach(tagName => { switch (tagName) {
        case "slots-tab":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, SlotsTab);
            }
            break;
    } });
}
