...
import { b as formatSrcDoc, a as assignLanguage, i as iframeListeners } from './p-BbO8WzMW.js';
...
const codeFrameCss = "@layer reset, default;\n\n@layer reset {\n  :host {\n    display: block;\n\n    slot {\n      display: initial;\n    }\n  }\n}\n\n@layer default {\n  :host {\n    margin: 0 0 var(--gcds-spacing-300);\n\n    .code-actions-bar,\n    .component-preview {\n      border: var(--gcds-border-width-md) solid var(--gcds-border-default);\n    }\n\n    .code-actions-bar {\n      display: flex;\n      flex-wrap: wrap;\n      gap: var(--gcds-spacing-300);\n      justify-content: space-between;\n      padding: var(--gcds-spacing-225);\n\n      gcds-select {\n        /* !!! TODO: Remove when label is fixed */\n        margin-block-start: calc(var(--gcds-spacing-75) * -1);\n        --gcds-select-margin: 0;\n      }\n    }\n\n    .component-preview {\n      padding: var(--gcds-spacing-350) var(--gcds-spacing-250);\n      border-block-start: 0;\n\n      iframe {\n        width: 100%;\n        height: var(--component-display-iframe-height, 12rem);\n        border: none;\n      }\n\n      @media only screen and (width >= 64em) {\n        overflow-x: scroll;\n\n        iframe {\n          width: var(--gcds-container-size-xl);\n        }\n      }\n    }\n\n    .code-preview {\n      margin-block-start: calc(var(--gcds-border-width-md) * -1);\n\n      &.hidden {\n        display: none;\n      }\n\n      pre {\n        border-radius: 0 !important;\n        margin: 0 !important;\n      }\n\n      gcds-button {\n        margin: var(--gcds-spacing-300) 0 0;\n\n        &:not(:hover) {\n          --gcds-button-secondary-default-text: var(--gcds-text-light);\n        }\n      }\n    }\n  }\n}\n";

const CodeFrame = /*@__PURE__*/ proxyCustomElement(class CodeFrame extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    */
    ...
    async formatCodePreview() {
        ...
        this.htmlCode = Prism$1.highlight(code, Prism$1.languages.html, 'html');
        this.vueCode = Prism$1.highlight(code, Prism$1.languages.html, 'html');
        this.reactCode = Prism$1.highlight(react, Prism$1.languages.jsx, 'jsx');
        this.angularCode = Prism$1.highlight(angular, Prism$1.languages.html, 'html');
    ...
    */
    ...
    static get style() { return prismCss + codeFrameCss; }
}, [1, "code-frame", {
        "source": [1],
...
function defineCustomElement() {
    ...
    const components = ["code-frame"];
    components.forEach(tagName => { switch (tagName) {
        case "code-frame":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, CodeFrame);
            }
            break;
    } });
}
...
export { CodeFrame as C, defineCustomElement as d };
//# sourceMappingURL=p-D5m_FF6B.js.map
