...
import { o as observerConfig, a as assignLanguage, e as emitEvent, i as inheritAttributes, l as logError, v as validationErrors, b as isValidDay, c as isValidDate, h as handleErrors, d as handleValidationResult, f as validateRadioCheckboxGroup, g as isValid, j as formatHTMLErrorMessage, k as closestElement } from './utils-C3z3Khaa.js';
...
const GcdsCheckboxes = class {
    ...
    render() {
        ...
        this.shadowElement = [];
        if (this.validateRequiredProps()) {
            return (h(Host, { key: 'a523f6d77cd9e2fd3f30b9d90fc4ca4e32c97f22', onBlur: () => this.isGroup && this.onBlurValidate() }, this.isGroup ? (h("fieldset", Object.assign({ class: "gcds-checkboxes__fieldset" }, fieldsetAttrs), h("legend", { id: "checkboxes-legend", class: "gcds-checkboxes__legend" }, this.hideLegend ? (h("gcds-sr-only", { tag: "span" }, legend, required && (h("span", { class: "legend__required" }, I18N$m[this.lang].required)))) : (h(Fragment, null, legend, required && (h("span", { class: "legend__required" }, I18N$m[this.lang].required))))), hint ? (h("gcds-hint", { id: "checkboxes-hint", "hint-id": "checkboxes" }, hint)) : null, errorMessage ? (h("div", null, h("gcds-error-message", { id: "checkboxes-error", messageId: "checkboxes" }, errorMessage))) : null, this.optionsArr &&
...
const GcdsDateInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: '94dec21a77e42646ecaae7593f9609ec3419a2f3', name: name, onBlur: () => this.onBlur() }, this.validateRequiredProps() && (h("fieldset", Object.assign({ key: '30ec72bc476564064bbc086e69a3b8722c91d71b', class: "gcds-date-input__fieldset" }, fieldsetAttrs, { ref: el => (this.fieldset = el) }), h("legend", { key: 'ed3fbeaaf9fe91b6f322741d93dfff40bbb2356a', id: "date-input-legend" }, legend, required ? (h("span", { class: "legend__required" }, I18N$l[lang].required)) : null), hint ? (h("gcds-hint", { id: "date-input-hint", "hint-id": "date-input" }, hint)) : null, errorMessage ? (h("div", null, h("gcds-error-message", { id: "date-input-error", messageId: "date-input" }, errorMessage))) : null, formatArray))));
    }
    static get delegatesFocus() { return true; }
    static get formAssociated() { return true; }
    get el() { return getElement(this); }
...
const GcdsErrorSummary = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'aabdf11e63871b1b04b82510cf1e204cfe4af997' }, h("div", { key: '3a42ace253a21dc1b2f6532f31002c4769da154b', role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
                ? 'gcds-show'
                : ''}` }, h("gcds-heading", { key: 'da08c194ae8467fd49e25ded57cef1ce76c59bf3', tag: "h2", "margin-top": "0", "margin-bottom": "225" }, heading !== null && heading !== void 0 ? heading : I18N$j[lang].heading), h("ol", { key: 'f3c9ac34f213bc43777c4f0cd8fc5f3649b1a62b', class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFooter = class {
    ...
    render() {
        ...
        let subLinkCount = 0;
        return (h(Host, { key: '6a0f9c4059caa2e30ef02a4bb51a552152c2bc4e', role: "contentinfo", "aria-label": "Footer" }, h("gcds-sr-only", { key: 'c6303a1cec09909530a3301fa5e5b2ef991a41d1', tag: "h2" }, I18N$h[lang].about), contextualLinksObject && contextualHeading && (h("div", { key: '07b21b1d7d83972f74c8bb0ab78a9e54f84c87eb', class: "gcds-footer__contextual" }, h("div", { key: '64417ee815a86dbf4871972bcfd138721dfdc497', class: "contextual__container" }, h("nav", { key: '4de71bc121ab044532922ce8e21278dc2d9329df', "aria-labelledby": "contextual__heading" }, h("h3", { key: '1ddcfa84c72e86ffb9c1558988dbc70c940e6c98', id: "contextual__heading", class: "contextual__heading" }, contextualHeading), h("ul", { key: '10f038c6286ca9e9e0ec1892797bd22d5cd7c1cf', class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
            if (contextualLinkCount < 3) {
                contextualLinkCount++;
                return (h("li", null, h("gcds-link", { size: "small", href: contextualLinksObject[key] }, key)));
            }
        })))))), display === 'full' ? (h("div", { class: "gcds-footer__main" }, h("div", { class: "main__container" }, h("nav", { class: "main__govnav", "aria-labelledby": "govnav__heading" }, h("h3", { id: "govnav__heading" }, I18N$h[lang].gov.heading), h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (h("li", null, h("gcds-link", { size: "small", href: govNav[value].link }, govNav[value].text)))))), h("nav", { class: "main__themenav", "aria-labelledby": "themenav__heading" }, h("gcds-sr-only", { tag: "h4", id: "themenav__heading" }, I18N$h[lang].themes.heading), h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (h("li", null, h("gcds-link", { size: "small", href: themeNav[value].link }, themeNav[value].text))))))))) : null, h("div", { key: '4909ad3592fd2304df8353e11947eca69aaa56aa', class: "gcds-footer__sub" }, h("div", { key: '3c4d3282dd8ead4b87df28591d94d6e6d327ef8d', class: "sub__container" }, h("nav", { key: 'ee1baa7d6ea78245af3451f128182683b51649a8', "aria-labelledby": "sub__heading" }, h("gcds-sr-only", { key: 'fa65fa21472446b67ea15179f27394ff95f238bf', tag: "h3", id: "sub__heading" }, I18N$h[lang].site.heading), h("ul", { key: '630f20304416893db2c67a6cda4400205a822a4b' }, subLinks
...
const GcdsHeading = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (h(Host, { key: '2264d5517d1bcdb762641c50cfa917c0b3fc9c3a' }, h(Tag, { key: '7e8626cd8cf236c6c4dbe8c1df2a70badb519e47', class: `
            gcds-heading
            ${headingRole ? `role-${headingRole}` : ''}
            ${characterLimit ? 'limit' : ''}
            ${marginTop ? `mt-${marginTop}` : ''}
            ${marginBottom ? `mb-${marginBottom}` : ''}
          ` }, h("slot", { key: 'b29840753341fa2405c39ede14c68ea806441702' }))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "tag": ["validateTag"],
...
const GcdsLangToggle = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f12de208eb52786450f1c4212e0b1d6716f75405' }, h("div", { key: '6c35c46a64ea431c30feb804c5c9b5022e181cd3', class: "gcds-lang-toggle" }, h("gcds-sr-only", { key: '0cbdffb1ae027b07fbf9f3a6af803af2a0f79f58', id: "lang-toggle__heading", tag: "h2" }, I18N$c[lang].heading), h("gcds-link", { key: 'fce48c5a07de4d05c78ac121feb93f86c18343f8', size: "regular", href: href, lang: I18N$c[lang].abbreviation }, h("span", { key: '4f7fe6e4596793f459dd834695b91948aa155839' }, I18N$c[lang].language), h("abbr", { key: '0c37e52fc3e196cf2d2666654044fc381e3c8cc6', title: I18N$c[lang].language }, I18N$c[lang].abbreviation)))));
    }
    get el() { return getElement(this); }
};
...
const GcdsLink = class {
    ...
    getIcon() {
        ...
        if (isExternal) {
            return h("gcds-icon", { name: "external", label: I18N$b[lang].external });
        }
        if (download !== undefined) {
            return h("gcds-icon", { name: "download", label: I18N$b[lang].download });
        }
        if (href === null || href === void 0 ? void 0 : href.toLowerCase().startsWith('mailto:')) {
            return h("gcds-icon", { name: "email", label: I18N$b[lang].email });
        }
        if (href === null || href === void 0 ? void 0 : href.toLowerCase().startsWith('tel:')) {
            return h("gcds-icon", { name: "phone", label: I18N$b[lang].phone });
        }
        return null;
    }
    render() {
    ...
    configurePaginationStep(page, end, mobile) {
        ...
        if (end) {
            return (h("li", { class: `list-btn-${end === 'next' ? 'next' : 'prev'}` }, end === 'next' ? (h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ...
                    : 'gcds-pagination-end-button-mobile' }), h("span", null, I18N$9[this.lang].listNext), h("gcds-icon", { "margin-left": "150", name: "chevron-right" }))) : (h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ? 'gcds-pagination-end-button'
...
const GcdsRadios = class {
    ...
    render() {
        ...
        if (this.validateRequiredProps()) {
            return (h(Host, { key: '3bd16e4a6cc77fc6114f37791a4342baef496716', onBlur: () => this.onBlurValidate() }, h("fieldset", Object.assign({ key: '8c91df0fae62ebcae079551bc5362e1770d2da23', class: "gcds-radios__fieldset" }, fieldsetAttrs), h("legend", { key: '7372c1addc1d1c715b58ca0dd3dcc75fc6c38be4', id: "radios-legend", class: "gcds-radios__legend" }, this.hideLegend ? (h("gcds-sr-only", { tag: "span" }, legend, required && h("span", { class: "legend__required" }, I18N$8[lang].required))) : (h(Fragment, null, legend, required && h("span", { class: "legend__required" }, I18N$8[lang].required)))), hint ? (h("gcds-hint", { id: "radios-hint", "hint-id": "radios" }, hint)) : null, errorMessage ? (h("gcds-error-message", { id: "radios-error", messageId: "radios" }, errorMessage)) : null, this.optionsArr &&
                this.optionsArr.map(radio => {
...
const GcdsSideNav = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'cb1dce8bcf9a4f6f6a83f40b9ae35a1f69eecb55' }, h("nav", { key: '4d6e131139f437afa494865a9a16546c28378764', "aria-label": `${label}${I18N$6[lang].navLabel}`, class: "gcds-side-nav" }, h("ul", { key: '545b0eed21a11fcb2795a81ca3ad54f29a4311c6' }, h("gcds-nav-group", { key: '62c894a97778e43064b83341ce52b064c4555779', menuLabel: I18N$6[lang].menuLabel, closeTrigger: I18N$6[lang].closeTrigger, openTrigger: I18N$6[lang].menuLabel, class: "gcds-mobile-nav", ref: element => (this.mobile = element), lang: lang }, h("slot", { key: 'edaa0c63d976d732bc5294c59e2b0346572a2a31', name: "home" }, h("li", { key: '45d762b61ace15f094077513b2aa09794e63e9e0', class: "gcds-side-nav__heading" }, label)), h("slot", { key: '2ed4c1c3c852a3213fa095ce9f0df30ac437abd4' }))))));
    }
    get el() { return getElement(this); }
};
...
const GcdsSignature = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'eec74b983904b1498601a6c1d12ac5aaf6821208' }, type === 'signature' ? (h(Tag, Object.assign({}, sigAttrs), h("div", { innerHTML: selectSVG }), h("gcds-sr-only", { tag: "span", lang: lang === 'en' ? 'fr' : 'en' }, lang === 'en'
            ? `/ ${I18N$5.fr.gc}`
            : `/ ${I18N$5.en.gc}`))) : (h("div", { class: "gcds-signature", innerHTML: selectSVG }))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "type": ["validateType"],
...
const renderSortRadios = (element) => {
    ...
    return (h("div", { class: "gcds-table__modal-sort" },
        h("gcds-heading", { tag: "h3", "margin-top": "0", "margin-bottom": "0" },
            h("gcds-icon", { name: "sort", "margin-right": "100", "aria-hidden": "true" }),
            I18N$3[lang].sort),
        h("gcds-radios", { legend: I18N$3[lang].sort, "hide-legend": true, name: "sort", autoFocus: true, options: radioOptions, value: isSorted, ref: el => (element.sortRadios = el) })));
};
    ...
    return (h("div", { class: "gcds-table__filters" },
            ...
            h("div", null,
                ...
                element.filter && element.sortEnabled()
                    ...
                    : element.filter
                        ? I18N$3[lang].filter
                        : I18N$3[lang].sort,
                filter && filterValue && (h(Fragment, null,
                    h("gcds-sr-only", { tag: "span" }, ":"),
                    h("span", { class: "gcds-table__active-count", "aria-label": `${I18N$3[lang].activeBadgeLabel.replace('{count}', 1)}` }, "1"))))),
        h("dialog", { class: "gcds-table__modal", "aria-modal": "true", "aria-labelledby": "gcds-table__modal-heading", ref: el => (element.filterSortModal = el) },
            h("div", { class: "gcds-table__modal-header" },
                h("gcds-heading", { tag: "h2", id: "gcds-table__modal-heading", marginTop: "0", marginBottom: "0" }, I18N$3[lang].filterAndSort),
            ...
            h("form", { class: "gcds-table__modal-body", onSubmit: ev => {
                ...
                h("div", { class: "gcds-table__modal-content" },
                    element.filter && (h("gcds-input", { class: "gcds-table__modal-filter", type: "search", label: I18N$3[lang].filter, name: "filter", inputId: "gcds-table-filter", autoFocus: true, value: filterValue, ref: el => (element.filterInput = el) })),
                ...
                h("div", { class: "gcds-table__modal-footer" },
                    ...
                    h("gcds-button", { "button-role": "primary", type: "submit" }, I18N$3[lang].modalApplyButton))))));
};
const renderFilterPills = (filterValue, lang, onRemove) => {
    if (!filterValue)
        return null;
    return (h("div", { class: "gcds-table__active-filter" },
        h("button", { class: "gcds-table__pill", onClick: onRemove, title: I18N$3[lang].pillRemoveFilter },
            h("gcds-sr-only", { tag: "span" }, I18N$3[lang].pillFilter),
            filterValue,
...
const renderSortPills = (sorting, table, lang, onRemove) => {
    ...
    return (h("div", { class: "gcds-table__active-sorting" },
        h("span", { class: "gcds-table__sort-label" }, I18N$3[lang].pillSort), sorting === null || sorting === void 0 ? void 0 :
        sorting.map(sort => {
            const column = table.getColumn(sort.id);
            if (!column)
                return null;
            return (h("button", { class: "gcds-table__pill", onClick: () => onRemove(column.id), title: I18N$3[lang].pillRemoveSort },
...
const GcdsTable = class {
    ...
    render() {
        ...
        return (h(Host, null, h("section", { class: "gcds-table" }, this.el.querySelector('[slot="caption"]') && (h("div", { id: "gcds-table__caption" }, h("slot", { name: "caption" }))), (this.filter || this.sortEnabled()) && renderFilterSortModal(this), h("div", { class: "gcds-table__active-pills" }, this.filter && renderFilterPills(this.filterValue, this.lang, () => {
            ...
            updateTableOptions(this);
        })), h("div", { class: "gcds-table__row-management" }, this.pagination && (h("div", { class: "gcds-table__page-size" }, h("gcds-select", { label: I18N$3[this.lang].rowsPerPage, name: "page-size", selectId: "gcds-table-page-size", value: this.paginationSize.toString(), onChange: e => this.handlePageSizeSelect(e) }, this.paginationSizeOptions.map(opt => (h("option", { key: opt, value: opt }, opt === 0 ? I18N$3[this.lang].all : opt)))))), h("span", { class: "gcds-table__page-info", role: "status", "aria-live": "polite" }, renderTableStatus(this.el, this.table, this.paginationState, this.lang))), h("table", { class: "gcds-table__table", tabindex: "-1", "aria-labelledby": this.el.querySelector('[slot="caption"]')
                ? 'gcds-table__caption'
                : undefined, ref: el => {
                if (el)
        ...
        }))))), h("tbody", null, rows.length === 0 ? (h("tr", null, h("td", { class: "gcds-table__empty", colSpan: ((_a = this.columns) !== null && _a !== void 0 ? _a : []).length }, this.filter && this.filterValue !== '' ? (h("div", null, h("gcds-heading", { tag: "h3", "heading-role": "secondary", "margin-top": "0", "margin-bottom": "100" }, I18N$3[this.lang].noResultsHeading), h("gcds-text", { "text-role": "secondary", "margin-bottom": "200" }, I18N$3[this.lang].noResultsText), h("gcds-button", { onClick: () => (this.filterValue = this.initialFilter) }, I18N$3[this.lang].noResultsClearFilter))) : (h("div", null, h("gcds-heading", { tag: "h3", "heading-role": "secondary", "margin-top": "0", "margin-bottom": "100" }, I18N$3[this.lang].noDataHeading), h("gcds-text", { "text-role": "secondary", "margin-bottom": "0" }, I18N$3[this.lang].noDataText)))))) : (rows.map(row => (h("tr", { key: row.id, "data-test": row.id, class: "gcds-table__row" }, row.getVisibleCells().map(cell => {
            var _a, _b;
        ...
        }))))))), this.pagination && this.paginationSize !== 0 && rows.length != 0 && (h("gcds-pagination", { display: "list", currentPage: this.paginationState.pageIndex + 1, totalPages: this.table.getPageCount(), label: I18N$3[this.lang].paginationLabel, onGcdsClick: e => this.handlePaginationClick(e), lang: this.lang })))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
