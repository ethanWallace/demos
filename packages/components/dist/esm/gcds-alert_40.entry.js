...
const renderSortRadios = (element) => {
    ...
    return (h("gcds-radios", { class: "gcds-table__modal-sort", legend: I18N$3[lang].sort, name: "sort", autoFocus: true, options: radioOptions, value: isSorted, ref: el => (element.sortRadios = el) }));
};
...
const GcdsTable = class {
    ...
    render() {
        ...
        return (h(Host, null, h("section", { class: "gcds-table" }, this.el.querySelector('[slot="caption"]') && (h("div", { id: "gcds-table__caption" }, h("slot", { name: "caption" }))), (this.filter || this.sortEnabled()) && renderFilterSortModal(this), h("div", { class: "gcds-table__active-pills" }, renderFilterPills(this.filterValue, this.lang, () => {
            ...
            h("div", null, h("gcds-heading", { tag: "h3", "heading-role": 'secondary' }, I18N$3[this.lang].noResultsHeading), h("gcds-text", { "text-role": 'secondary' }, I18N$3[this.lang].noResultsText), h("gcds-button", { onClick: () => this.filterValue = this.initialFilter }, I18N$3[this.lang].noResultsClearFilter))
            :
                h("div", null, h("gcds-heading", { tag: "h3", "heading-role": 'secondary' }, I18N$3[this.lang].noDataHeading), h("gcds-text", { "text-role": 'secondary' }, I18N$3[this.lang].noDataText))))) : (rows.map(row => (h("tr", { key: row.id, "data-test": row.id, class: "gcds-table__row" }, row.getVisibleCells().map(cell => {
            var _a, _b;
        ...
        }))))))), this.pagination && this.paginationSize !== 0 && (h("gcds-pagination", { display: "list", currentPage: this.paginationState.pageIndex + 1, totalPages: this.table.getPageCount(), label: I18N$3[this.lang].paginationLabel, onGcdsClick: e => this.handlePaginationClick(e) }))), h("slot", null)));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
