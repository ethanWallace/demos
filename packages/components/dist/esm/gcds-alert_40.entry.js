...
const GcdsButton = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f66acbffcd0a9ad259e72475e8899ea3cd03c171' }, h(Tag, Object.assign({ key: '9a133537992501c37c98b393c0238c252d5bb3b7' }, attrs, { id: buttonId, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => !disabled ? this.handleClick(e) : e.stopImmediatePropagation(), class: `gcds-button button--role-${buttonRole} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), h("slot", { key: '6182e46131e20271386f52fd53e95490876fbb55' }), type === 'link' && target === '_blank' ? (h("gcds-icon", { name: "external", label: I18N$o[lang].label, "margin-left": "150" })) : null)));
    }
...
const GcdsDateModified = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1c0180127dc767b6325799407aee9610452ba009' }, this.validateRequiredProps() && (h("dl", { key: 'd4814585e3662edd273b2b5ba51f4afca50c2f9d', class: "gcds-date-modified" }, h("dt", { key: 'c0f27815209a9a37e5a8d16bde2ccd0dc6beea2d' }, h("gcds-text", { key: '1295064a3da09ce540b1236eac44aad5dc0dec27', display: "inline", "margin-bottom": "0" }, type === 'version' ? I18N$k[lang].version : I18N$k[lang].date)), h("dd", { key: '84ab0a6e2f87a96a7159bfc63670ce6f60fc9c53' }, h("gcds-text", { key: '28857771b0c12e53e246e7d8c04f473667d1e99a', display: "inline", "margin-bottom": "0" }, type === 'version' ? (h("slot", null)) : (h("time", null, h("slot", null)))))))));
    }
    get el() { return getElement(this); }
};
...
const GcdsErrorSummary = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8357850a4bbf857b53c87f57c99f19531a850c24' }, h("div", { key: '0ecb4bca42f58e44a44a20b949228d0c0298756f', role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
                ? 'gcds-show'
                : ''}` }, h("gcds-heading", { key: '796ceab1bc0936c5bb0bdbf36167c1e91304fdd3', tag: "h2", "margin-top": "0", "margin-bottom": "225" }, heading !== null && heading !== void 0 ? heading : I18N$j[lang].heading), h("ol", { key: 'c48b80ded47df7e1041a1b84d1152d3ae7c2bd70', class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFooter = class {
    ...
    render() {
        ...
        let subLinkCount = 0;
        return (h(Host, { key: 'f1b8da552d3024692e8a2a617e9009aa3757fa14', role: "contentinfo", "aria-label": "Footer" }, h("gcds-sr-only", { key: '29c26f6e7b8fd4004a7f0ff572e101b12518c5a1', tag: "h2" }, I18N$h[lang].about), contextualLinksObject && contextualHeading && (h("div", { key: '56310768170e0095b55dc958685f31612f97884b', class: "gcds-footer__contextual" }, h("div", { key: '6f969587463df4f2486492421a9f0a2d08dbdc08', class: "contextual__container" }, h("nav", { key: 'c2cddfebf418a7d14eb50e9bb854c80d12c58c28', "aria-labelledby": "contextual__heading" }, h("h3", { key: '96f67bd4be77214e4f3aa794e87d6c6c8589646f', id: "contextual__heading", class: "contextual__heading" }, contextualHeading), h("ul", { key: '9acda60496ee805776ed0f1ff375da195d3a2616', class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
            if (contextualLinkCount < 3) {
                contextualLinkCount++;
                return (h("li", null, h("gcds-link", { size: "small", href: contextualLinksObject[key] }, key)));
            }
        })))))), display === 'full' ? (h("div", { class: "gcds-footer__main" }, h("div", { class: "main__container" }, h("nav", { class: "main__govnav", "aria-labelledby": "govnav__heading" }, h("h3", { id: "govnav__heading" }, I18N$h[lang].gov.heading), h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (h("li", null, h("gcds-link", { size: "small", href: govNav[value].link }, govNav[value].text)))))), h("nav", { class: "main__themenav", "aria-labelledby": "themenav__heading" }, h("gcds-sr-only", { tag: "h4", id: "themenav__heading" }, I18N$h[lang].themes.heading), h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (h("li", null, h("gcds-link", { size: "small", href: themeNav[value].link }, themeNav[value].text))))))))) : null, h("div", { key: '79a17bdbee68f0285ff012bd7cdd20ca866e664b', class: "gcds-footer__sub" }, h("div", { key: 'aef50d91b3e5516a243d4c291495d8e5d7037796', class: "sub__container" }, h("nav", { key: 'dcf518e4d3c42fd079127d1f941104d56399499a', "aria-labelledby": "sub__heading" }, h("gcds-sr-only", { key: 'e7aaa4d7bd8b60ec410c844804062bfeb0a41225', tag: "h3", id: "sub__heading" }, I18N$h[lang].site.heading), h("ul", { key: '4131cef714c576d9386e9bcfc7f0c002179e3de1' }, subLinks
...
const renderFilterSortModal = element => {
    ...
    return (h("div", { class: "gcds-table__filters" }, h("gcds-button", { size: "small", "button-role": "primary", onClick: () => element.filterSortModal.showModal() }, h("div", null, element.filter && element.sortEnabled() ? (h("gcds-icon", { name: "tune", size: "h5", "margin-right": "50" })) : element.filter ? (h("gcds-icon", { name: "filter", size: "h5", "margin-right": "50" })) : (h("gcds-icon", { name: "sort", size: "h5", "margin-right": "50" })), element.filter && element.sortEnabled()
        ...
        : element.filter
            ? I18N$3[lang].filter
            : I18N$3[lang].sort, filter && filterValue && (h(Fragment, null, h("gcds-sr-only", { tag: "span" }, ":"), h("span", { class: "gcds-table__active-count", "aria-label": `${I18N$3[lang].activeBadgeLabel.replace('{count}', 1)}` }, "1"))))), h("dialog", { class: "gcds-table__modal", "aria-modal": "true", "aria-labelledby": "gcds-table__modal-heading", ref: el => (element.filterSortModal = el) }, h("div", { class: "gcds-table__modal-header" }, h("gcds-heading", { tag: "h2", id: "gcds-table__modal-heading", marginTop: "0", marginBottom: "0" }, I18N$3[lang].filterAndSort), h("gcds-button", { "button-role": "secondary", onClick: () => {
        ...
        } }, I18N$3[lang].modalClose)), h("form", { class: "gcds-table__modal-body", onSubmit: ev => {
            ev.preventDefault();
            if (element.filter) {
        ...
        } }, I18N$3[lang].modalResetAllButton), h("gcds-button", { "button-role": "primary", type: "submit" }, I18N$3[lang].modalApplyButton))))));
};
const renderFilterPills = (filterValue, lang, onRemove) => {
    if (!filterValue)
        return null;
    return (h("div", { class: "gcds-table__active-filter" }, h("button", { class: "gcds-table__pill", onClick: onRemove, title: I18N$3[lang].pillRemoveFilter }, h("gcds-sr-only", { tag: "span" }, I18N$3[lang].pillFilter), filterValue, h("gcds-icon", { name: "close", size: "text-small" }))));
};
const renderSortPills = (sorting, table, lang, onRemove) => {
    if ((sorting === null || sorting === void 0 ? void 0 : sorting.length) === 0)
        return null;
    return (h("div", { class: "gcds-table__active-sorting" }, h("span", { class: "gcds-table__sort-label" }, I18N$3[lang].pillSort), sorting === null || sorting === void 0 ? void 0 :
        sorting.map(sort => {
            const column = table.getColumn(sort.id);
            if (!column)
                return null;
            return (h("button", { class: "gcds-table__pill", onClick: () => onRemove(column.id), title: I18N$3[lang].pillRemoveSort }, `${column.columnDef.header} (${sort.desc ? I18N$3[lang].descending : I18N$3[lang].ascending})`, h("gcds-icon", { name: "close", size: "text-small" })));
        })));
};
...
const GcdsTable = class {
    ...
    render() {
        ...
        return (h(Host, null, h("section", { class: "gcds-table" }, this.el.querySelector('[slot="caption"]') && (h("div", { id: "gcds-table__caption" }, h("slot", { name: "caption" }))), (this.filter || this.sortEnabled()) && renderFilterSortModal(this), h("div", { class: "gcds-table__active-pills" }, this.filter && renderFilterPills(this.filterValue, this.lang, () => {
            ...
            (h("gcds-pagination", { display: "list", currentPage: this.paginationState.pageIndex + 1, totalPages: this.table.getPageCount(), label: I18N$3[this.lang].paginationLabel, onGcdsClick: e => this.handlePaginationClick(e), lang: this.lang })))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "columns": [{
