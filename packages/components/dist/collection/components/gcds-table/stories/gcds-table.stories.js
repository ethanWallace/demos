...
export default {
    ...
    argTypes: Object.assign(Object.assign({
        ...
        // Events
        gcdsTableStateChange: Object.assign({ action: 'click' }, eventProp)
    }),
};
const Template = args => `
...
Filter.args = Object.assign(Object.assign({}, defaultTableProperties), { filter: true });
// ------ Table filter value ------
export const FilterValue = Template.bind({});
FilterValue.args = Object.assign(Object.assign({}, defaultTableProperties), { filter: true, filterValue: 'Approved' });
// ------ Table pagination ------
export const Pagination = Template.bind({});
Pagination.args = Object.assign(Object.assign({}, defaultTableProperties), { pagination: true });
// ------ Table pagination current page ------
export const PaginationCurrentPage = Template.bind({});
PaginationCurrentPage.args = Object.assign(Object.assign({}, defaultTableProperties), { pagination: true, paginationCurrentPage: 2 });
// ------ Table pagination size ------
export const PaginationSize = Template.bind({});
PaginationSize.args = Object.assign(Object.assign({}, defaultTableProperties), { pagination: true, paginationSize: 25 });
// ------ Table pagination size options ------
export const PaginationSizeOptions = Template.bind({});
PaginationSizeOptions.args = Object.assign(Object.assign({}, defaultTableProperties), { pagination: true, paginationSizeOptions: '[5, 10, 15, 20, 0]' });
// ------ Table sort ------
export const Sort = Template.bind({});
Sort.args = Object.assign(Object.assign({}, defaultTableProperties), { sort: true });
// ------ Table columns sortDirection ------
export const ColumnsSort = Template.bind({});
ColumnsSort.args = Object.assign(Object.assign({}, defaultTableProperties), { sort: true, columns: JSON.stringify([
        {
            field: 'id',
            header: 'ID',
        },
...
ColumnsRowHeader.args = Object.assign(Object.assign({}, defaultTableProperties), { sort: true, columns: JSON.stringify([
        {
            field: 'id',
            header: 'ID',
            rowHeader: true,
