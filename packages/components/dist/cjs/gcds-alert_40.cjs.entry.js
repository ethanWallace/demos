...
var utils = require('./utils-CJ4BVQqM.js');
...
const GcdsDateInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '94dec21a77e42646ecaae7593f9609ec3419a2f3', name: name, onBlur: () => this.onBlur() }, this.validateRequiredProps() && (index.h("fieldset", Object.assign({ key: '30ec72bc476564064bbc086e69a3b8722c91d71b', class: "gcds-date-input__fieldset" }, fieldsetAttrs, { ref: el => (this.fieldset = el) }), index.h("legend", { key: 'ed3fbeaaf9fe91b6f322741d93dfff40bbb2356a', id: "date-input-legend" }, legend, required ? (index.h("span", { class: "legend__required" }, I18N$l[lang].required)) : null), hint ? (index.h("gcds-hint", { id: "date-input-hint", "hint-id": "date-input" }, hint)) : null, errorMessage ? (index.h("div", null, index.h("gcds-error-message", { id: "date-input-error", messageId: "date-input" }, errorMessage))) : null, formatArray))));
    }
    static get delegatesFocus() { return true; }
    static get formAssociated() { return true; }
    get el() { return index.getElement(this); }
...
const GcdsErrorSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'aabdf11e63871b1b04b82510cf1e204cfe4af997' }, index.h("div", { key: '3a42ace253a21dc1b2f6532f31002c4769da154b', role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
                ? 'gcds-show'
                : ''}` }, index.h("gcds-heading", { key: 'da08c194ae8467fd49e25ded57cef1ce76c59bf3', tag: "h2", "margin-top": "0", "margin-bottom": "225" }, heading !== null && heading !== void 0 ? heading : I18N$j[lang].heading), index.h("ol", { key: 'f3c9ac34f213bc43777c4f0cd8fc5f3649b1a62b', class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFooter = class {
    ...
    render() {
        ...
        let subLinkCount = 0;
        return (index.h(index.Host, { key: '6a0f9c4059caa2e30ef02a4bb51a552152c2bc4e', role: "contentinfo", "aria-label": "Footer" }, index.h("gcds-sr-only", { key: 'c6303a1cec09909530a3301fa5e5b2ef991a41d1', tag: "h2" }, I18N$h[lang].about), contextualLinksObject && contextualHeading && (index.h("div", { key: '07b21b1d7d83972f74c8bb0ab78a9e54f84c87eb', class: "gcds-footer__contextual" }, index.h("div", { key: '64417ee815a86dbf4871972bcfd138721dfdc497', class: "contextual__container" }, index.h("nav", { key: '4de71bc121ab044532922ce8e21278dc2d9329df', "aria-labelledby": "contextual__heading" }, index.h("h3", { key: '1ddcfa84c72e86ffb9c1558988dbc70c940e6c98', id: "contextual__heading", class: "contextual__heading" }, contextualHeading), index.h("ul", { key: '10f038c6286ca9e9e0ec1892797bd22d5cd7c1cf', class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
            if (contextualLinkCount < 3) {
                contextualLinkCount++;
                return (index.h("li", null, index.h("gcds-link", { size: "small", href: contextualLinksObject[key] }, key)));
            }
        })))))), display === 'full' ? (index.h("div", { class: "gcds-footer__main" }, index.h("div", { class: "main__container" }, index.h("nav", { class: "main__govnav", "aria-labelledby": "govnav__heading" }, index.h("h3", { id: "govnav__heading" }, I18N$h[lang].gov.heading), index.h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: govNav[value].link }, govNav[value].text)))))), index.h("nav", { class: "main__themenav", "aria-labelledby": "themenav__heading" }, index.h("gcds-sr-only", { tag: "h4", id: "themenav__heading" }, I18N$h[lang].themes.heading), index.h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: themeNav[value].link }, themeNav[value].text))))))))) : null, index.h("div", { key: '4909ad3592fd2304df8353e11947eca69aaa56aa', class: "gcds-footer__sub" }, index.h("div", { key: '3c4d3282dd8ead4b87df28591d94d6e6d327ef8d', class: "sub__container" }, index.h("nav", { key: 'ee1baa7d6ea78245af3451f128182683b51649a8', "aria-labelledby": "sub__heading" }, index.h("gcds-sr-only", { key: 'fa65fa21472446b67ea15179f27394ff95f238bf', tag: "h3", id: "sub__heading" }, I18N$h[lang].site.heading), index.h("ul", { key: '630f20304416893db2c67a6cda4400205a822a4b' }, subLinks
...
const GcdsHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9fd063dd0539efb37e4d41b35f7b8078f6912fe0', role: "banner" }, renderSkipToNav, hasBanner ? index.h("slot", { name: "banner" }) : null, index.h("div", { key: '0079ad9eda976dc6b6873d201a61b80e89b22a92', class: "gcds-header__brand" }, index.h("div", { key: '47ee01dbea84f15e6a5bcf8ec887602e0a8aac6e', class: `brand__container ${!hasSearch ? 'container--simple' : ''}` }, renderToggle, renderSignature, renderSearch)), hasThemeTopicMenu ? (index.h("div", { class: "gcds-header__container--menu" }, index.h("slot", { name: "menu" }), hasAccount ? index.h("slot", { name: "account" }) : null)) : index.h("slot", { name: "menu" }), hasBreadcrumb || (!hasBreadcrumb && !hasThemeTopicMenu && hasAccount) ? (index.h("div", { class: "gcds-header__container--breadcrumbs" }, hasBreadcrumb ? index.h("slot", { name: "breadcrumb" }) : null, hasAccount && !hasThemeTopicMenu ? index.h("slot", { name: "account" }) : null)) : null));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsHeading = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (index.h(index.Host, { key: '2264d5517d1bcdb762641c50cfa917c0b3fc9c3a' }, index.h(Tag, { key: '7e8626cd8cf236c6c4dbe8c1df2a70badb519e47', class: `
            gcds-heading
            ${headingRole ? `role-${headingRole}` : ''}
            ${characterLimit ? 'limit' : ''}
            ${marginTop ? `mt-${marginTop}` : ''}
            ${marginBottom ? `mb-${marginBottom}` : ''}
          ` }, index.h("slot", { key: 'b29840753341fa2405c39ede14c68ea806441702' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "tag": ["validateTag"],
...
const GcdsHint = class {
    ...
    render() {
        const { hintId } = this;
        return (index.h(index.Host, { key: '17f8d587edb3e60141a007d2bba173e6dec0d021', id: `hint-${hintId}` }, index.h("gcds-text", { key: '8cb2346f614ff75373ad921147ea4e02f412dc01', class: "gcds-hint", "margin-bottom": "0", part: "hint" }, index.h("slot", { key: 'ea689ce20d55cba6e5b940210de6b03824fd5170' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsIcon = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '69756aae425a88b36d8d56718696f3ada91c8f02' }, index.h("span", { key: 'ed743ade6011d81a308291f69ed553b63c98e2f8', class: `
...
const GcdsNavGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8cba49f224e4d63954ba4bc3d91cf7db6f0e4923', role: "listitem", open: open }, index.h("div", { key: '80a76c44db22078f2be2d5ddcb2575f4b4e0dcc8', class: "gcds-nav-group__container" }, index.h("button", { key: '9230f7189eb1a178cf644440e9b9853af792eaab', "aria-haspopup": "true", tabIndex: 0, "aria-expanded": open.toString(), ref: element => (this.triggerElement = element), class: `gcds-nav-group__trigger gcds-trigger--${this.navStyle}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => {
                const event = utils.emitEvent(e, this.gcdsClick);
                if (event) {
                    this.toggleNav();
                }
            } }, index.h("gcds-icon", { key: 'd014bd69dc8d8e552292c1f18bc82c96488deea9', name: this.navStyle === 'expandable'
                ? open
                    ? 'chevron-down'
                    : 'chevron-right'
                : open
                    ? 'chevron-up'
                    : 'chevron-down' }), closeTrigger && open ? closeTrigger : openTrigger), index.h("ul", { key: 'f539e98b85d067de9a53ed07ce0d6f24ca1ed3cb', "aria-label": menuLabel, class: `gcds-nav-group__list gcds-nav--${this.navStyle}` }, index.h("slot", { key: '0ece17ae3b236863bfd90cd5d8759295deeb0032' })))));
    }
    get el() { return index.getElement(this); }
};
...
const renderSortRadios = (element) => {
    ...
    return (index.h("div", { class: "gcds-table__modal-sort" },
        index.h("gcds-heading", { tag: "h3", "margin-top": "0", "margin-bottom": "0" },
            index.h("gcds-icon", { name: "sort", "margin-right": "100", "aria-hidden": "true" }),
            I18N$3[lang].sort),
        index.h("gcds-radios", { legend: I18N$3[lang].sort, "hide-legend": true, name: "sort", autoFocus: true, options: radioOptions, value: isSorted, ref: el => (element.sortRadios = el) })));
};
...
const renderFilterSortModal = element => {
    ...
    return (index.h("div", { class: "gcds-table__filters" },
        index.h("gcds-button", { size: "small", buttonRole: "primary", onClick: () => element.filterSortModal.showModal() },
            index.h("div", null,
                element.filter && element.sortEnabled() ? (index.h("gcds-icon", { name: "tune", size: "h5", "margin-right": "50" })) : element.filter ? (index.h("gcds-icon", { name: "filter", size: "h5", "margin-right": "50" })) : (index.h("gcds-icon", { name: "sort", size: "h5", "margin-right": "50" })),
        ...
        index.h("dialog", { class: "gcds-table__modal", "aria-modal": "true", "aria-labelledby": "gcds-table__modal-heading", ref: el => (element.filterSortModal = el) },
            index.h("div", { class: "gcds-table__modal-header" },
                index.h("gcds-heading", { tag: "h2", id: "gcds-table__modal-heading", marginTop: "0", marginBottom: "0" }, I18N$3[lang].filterAndSort),
            ...
            index.h("form", { class: "gcds-table__modal-body", onSubmit: ev => {
                ...
                index.h("div", { class: "gcds-table__modal-content" },
                    element.filter && (index.h("gcds-input", { class: "gcds-table__modal-filter", type: "search", label: I18N$3[lang].filter, name: "filter", inputId: "gcds-table-filter", autoFocus: true, value: filterValue, ref: el => (element.filterInput = el) })),
                ...
                index.h("div", { class: "gcds-table__modal-footer" },
                    index.h("gcds-button", { "button-role": "secondary", onClick: () => {
                        ...
                        } }, I18N$3[lang].modalResetAllButton),
                    index.h("gcds-button", { "button-role": "primary", type: "submit" }, I18N$3[lang].modalApplyButton))))));
};
const renderFilterPills = (filterValue, lang, onRemove) => {
    if (!filterValue)
        return null;
    return (index.h("div", { class: "gcds-table__active-filter" },
        index.h("button", { class: "gcds-table__pill", onClick: onRemove, title: I18N$3[lang].pillRemoveFilter },
            index.h("gcds-sr-only", { tag: "span" }, I18N$3[lang].pillFilter),
            filterValue,
...
const GcdsTable = class {
    ...
    render() {
        ...
        }))))))), this.pagination && this.paginationSize !== 0 && rows.length != 0 && (index.h("gcds-pagination", { display: "list", currentPage: this.paginationState.pageIndex + 1, totalPages: this.table.getPageCount(), label: I18N$3[this.lang].paginationLabel, onGcdsClick: e => this.handlePaginationClick(e), lang: this.lang })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
