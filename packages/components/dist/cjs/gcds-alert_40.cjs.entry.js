...
const GcdsIcon = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cb27f69445e385805d3c2b52b21a6fbbe53ebb61' }, index.h("span", { key: '0285f889cdac2ccedf88c03e8e02cbdcc5ade5d1', class: `
...
const renderSortRadios = (element) => {
    ...
    return (index.h("gcds-radios", { class: "gcds-table__modal-sort", legend: I18N$3[lang].sort, name: "sort", autoFocus: true, options: radioOptions, value: isSorted, ref: el => (element.sortRadios = el) }));
};
...
const GcdsTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("section", { class: "gcds-table" }, this.el.querySelector('[slot="caption"]') && (index.h("div", { id: "gcds-table__caption" }, index.h("slot", { name: "caption" }))), (this.filter || this.sortEnabled()) && renderFilterSortModal(this), index.h("div", { class: "gcds-table__active-pills" }, renderFilterPills(this.filterValue, this.lang, () => {
        ...
        }))))), index.h("tbody", null, rows.length === 0 ? (index.h("tr", null, index.h("td", { class: "gcds-table__empty", colSpan: ((_a = this.columns) !== null && _a !== void 0 ? _a : []).length }, this.filter && this.filterValue !== '' ?
            index.h("div", null, index.h("gcds-heading", { tag: "h3", "heading-role": 'secondary' }, I18N$3[this.lang].noResultsHeading), index.h("gcds-text", { "text-role": 'secondary' }, I18N$3[this.lang].noResultsText), index.h("gcds-button", { onClick: () => this.filterValue = this.initialFilter }, I18N$3[this.lang].noResultsClearFilter))
            :
                index.h("div", null, index.h("gcds-heading", { tag: "h3", "heading-role": 'secondary' }, I18N$3[this.lang].noDataHeading), index.h("gcds-text", { "text-role": 'secondary' }, I18N$3[this.lang].noDataText))))) : (rows.map(row => (index.h("tr", { key: row.id, "data-test": row.id, class: "gcds-table__row" }, row.getVisibleCells().map(cell => {
            var _a, _b;
            ...
            cellContent = !isSlotted
                ? fallbackValue
                : (index.h("slot", { name: this.getManagedSlotName(row.id, cell.column.id) }, fallbackValue));
        ...
        }))))))), this.pagination && this.paginationSize !== 0 && (index.h("gcds-pagination", { display: "list", currentPage: this.paginationState.pageIndex + 1, totalPages: this.table.getPageCount(), label: I18N$3[this.lang].paginationLabel, onGcdsClick: e => this.handlePaginationClick(e) }))), index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
