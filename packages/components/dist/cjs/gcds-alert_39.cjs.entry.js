...
const GcdsBreadcrumbsItem = class {
    ...
    render() {
        const { href } = this;
        return (index.h(index.Host, { key: '95b1e4dcb1f26c4bbecaed7084c46f7440a939c9', role: "listitem", class: "gcds-breadcrumbs-item" }, index.h("gcds-link", { key: 'c60332192cfe17f487017acbd89a49adbc288e19', size: "regular", href: href }, index.h("slot", { key: '34993248082e9a129d2753695db93a7b5ac771f1' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c74bb5718df4b19c7fa434450a2fd3eebb099232' }, index.h(Tag, Object.assign({ key: 'a7446861dbd485ea41faecace76bb84cf352b1c1' }, attrs, { id: buttonId, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => !disabled ? this.handleClick(e) : e.stopImmediatePropagation(), class: `gcds-button button--role-${buttonRole} button--${size}`, ref: element => (this.shadowElement = element) }, inheritedAttributes, { part: "button" }), index.h("slot", { key: '6db6dd55d80f3b06cef1e477ea56b8bbf59734f4' }), type === 'link' && target === '_blank' ? (index.h("gcds-icon", { name: "external", label: I18N$n[lang].label, "margin-left": "150" })) : null)));
    }
...
const GcdsCard = class {
    ...
    render() {
        ...
        if (this.validateRequiredProps()) {
            return (index.h(index.Host, { key: 'dd00869ab8d4fb7fd9abf68b0432899a475cedf8' }, index.h("div", { key: '8f57992a1de761c5510f037b2a8136459f07b14d', class: "gcds-card" }, badge && !errors.includes('badge') && (index.h("gcds-text", { key: '42c7fc2a3c8b69d1cc454adb9ca1767fc9986566', id: "gcds-badge", class: "gcds-badge", "text-role": "light", "margin-bottom": "0", size: "small" }, index.h("strong", { key: '32c13a05860a19a0a43ea995f645507604d9452c' }, index.h("gcds-sr-only", { key: '2e47faade10e8138cbca10994293d9cd23c573a5', tag: "span" }, I18N$m[lang].tagged), badge))), imgSrc && (index.h("img", { key: '6ccf1faa6faf20a9991e5374fef4ce96b71532ae', src: imgSrc, alt: imgAlt ? imgAlt : '', class: "gcds-card__image" })), Element ? (index.h(Element, Object.assign({ class: "gcds-card__title" }, taggedAttr), index.h("gcds-link", { href: href }, cardTitle))) : (index.h("gcds-link", Object.assign({ href: href, class: "gcds-card__title", rel: rel, target: target }, taggedAttr), cardTitle)), renderDescription)));
        }
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsCheckboxes = class {
    ...
    render() {
        ...
        this.shadowElement = [];
        if (this.validateRequiredProps()) {
            return (index.h(index.Host, { key: 'a523f6d77cd9e2fd3f30b9d90fc4ca4e32c97f22', onBlur: () => this.isGroup && this.onBlurValidate() }, this.isGroup ? (index.h("fieldset", Object.assign({ class: "gcds-checkboxes__fieldset" }, fieldsetAttrs), index.h("legend", { id: "checkboxes-legend", class: "gcds-checkboxes__legend" }, this.hideLegend ? (index.h("gcds-sr-only", { tag: "span" }, legend, required && (index.h("span", { class: "legend__required" }, I18N$l[this.lang].required)))) : (index.h(index.Fragment, null, legend, required && (index.h("span", { class: "legend__required" }, I18N$l[this.lang].required))))), hint ? (index.h("gcds-hint", { id: "checkboxes-hint", "hint-id": "checkboxes" }, hint)) : null, errorMessage ? (index.h("div", null, index.h("gcds-error-message", { id: "checkboxes-error", messageId: "checkboxes" }, errorMessage))) : null, this.optionsArr &&
...
const GcdsContainer = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (index.h(index.Host, { key: 'c8b1e6c3e57435cc8998b15b27cb46d7c6aa2957' }, index.h(Tag, { key: '2288e5b16bcb4a169b9ba792f17fba37966041a8', class: `
            gcds-container
            ...
            ${padding ? `p-${padding}` : ''}
            ${size ? `size-${size}` : ''}
          ` }, index.h("slot", { key: '660586f2cb48bcfdf6eec5917e58cd6775c2f387' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsDateInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '94dec21a77e42646ecaae7593f9609ec3419a2f3', name: name, onBlur: () => this.onBlur() }, this.validateRequiredProps() && (index.h("fieldset", Object.assign({ key: '30ec72bc476564064bbc086e69a3b8722c91d71b', class: "gcds-date-input__fieldset" }, fieldsetAttrs, { ref: el => (this.fieldset = el) }), index.h("legend", { key: 'ed3fbeaaf9fe91b6f322741d93dfff40bbb2356a', id: "date-input-legend" }, legend, required ? (index.h("span", { class: "legend__required" }, I18N$k[lang].required)) : null), hint ? (index.h("gcds-hint", { id: "date-input-hint", "hint-id": "date-input" }, hint)) : null, errorMessage ? (index.h("div", null, index.h("gcds-error-message", { id: "date-input-error", messageId: "date-input" }, errorMessage))) : null, formatArray))));
    }
    static get delegatesFocus() { return true; }
    static get formAssociated() { return true; }
    get el() { return index.getElement(this); }
...
const GcdsDateModified = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8d15998c9617fa0ac4bb3fdc3dae6fc6bdce9413' }, this.validateRequiredProps() && (index.h("dl", { key: '4de9578f1f96c965847214b82b2285303931c75f', class: "gcds-date-modified" }, index.h("dt", { key: '0c7d1942bbcd97af004c3c111abab9e9fa359e1a' }, index.h("gcds-text", { key: '918144a11135a26ebb0168f24c9d85492e9fcf4a', display: "inline", "margin-bottom": "0" }, type === 'version' ? I18N$j[lang].version : I18N$j[lang].date)), index.h("dd", { key: '62e867808d365eeaceea76b3d613c158014eb44a' }, index.h("gcds-text", { key: 'b352283de5aadff853688ff828cbd27364adc3b2', display: "inline", "margin-bottom": "0" }, type === 'version' ? (index.h("slot", null)) : (index.h("time", null, index.h("slot", null)))))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsDetails = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0d107b1dc773b9cedb53f2ff49ffdfef927ee462' }, index.h("div", { key: '8e6c82eb769d30fcdd00551cdc57a68cbe5f12a8', class: "gcds-details" }, index.h("button", { key: '2deb6b323c9f24e4fd7e80b9d399a2df7d2d1fa3', "aria-expanded": open.toString(), "aria-controls": "details__panel", onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => {
                const event = utils.emitEvent(e, this.gcdsClick);
                if (event) {
                    this.toggle();
                }
            }, class: "details__summary", id: "details__summary" }, detailsTitle), index.h("details", { key: 'a5767c51f7bff82551439dff6302521fbeaefe2e', open: open, id: "details__panel", class: "details__panel", "aria-labelledby": "details__summary", onToggle: ev => this.handleToggle(ev), ref: element => (this.detailsElement = element) }, index.h("summary", { key: '3072f177cb51207b9b94e70666c71aba4336705a' }, detailsTitle), index.h("slot", { key: 'ba33ecdb88ed9a51914713a16e4260c265634b5e' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsErrorMessage = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c46004716d37a41b000ff3ffab62c63180e188ba', id: `error-message-${messageId}`, class: "gcds-error-message-wrapper" }, index.h("gcds-text", { key: 'c53d63bc30351226b2d03eed6c9f86eaec4652f2', class: "error-message", role: "alert", "margin-bottom": "75" }, index.h("gcds-icon", { key: '3bf459de433f1e89e24137b262e69e191059487d', name: "warning-triangle", "margin-right": "50" }), index.h("strong", { key: 'b5447dbab78b57dd418906e7132970569f818308' }, index.h("slot", { key: '4ff24d41c1cab1e0cece130dac6a391806241c0f' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsErrorSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'aabdf11e63871b1b04b82510cf1e204cfe4af997' }, index.h("div", { key: '3a42ace253a21dc1b2f6532f31002c4769da154b', role: "alert", tabindex: "-1", ref: element => (this.shadowElement = element), class: `gcds-error-summary ${(hasSubmitted || errorLinks) && Object.keys(errorQueue).length > 0
                ? 'gcds-show'
                : ''}` }, index.h("gcds-heading", { key: 'da08c194ae8467fd49e25ded57cef1ce76c59bf3', tag: "h2", "margin-top": "0", "margin-bottom": "225" }, heading !== null && heading !== void 0 ? heading : I18N$i[lang].heading), index.h("ol", { key: 'f3c9ac34f213bc43777c4f0cd8fc5f3649b1a62b', class: "summary__errorlist" }, (hasSubmitted || errorLinks) &&
...
const GcdsFileUploader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '342d3516761caa694a7d9f8d38aac3020a5b2e39' }, index.h("div", { key: 'fd0dfb14b09fc103b9bfd7c3c4660849e62ba6b3', class: `gcds-file-uploader-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({ key: 'f81d17ed5e7bf8aba3437c07c0a08f38d1419ba2' }, attrsLabel, { "hide-label": hideLabel, "label-for": uploaderId, lang: lang })), hint ? index.h("gcds-hint", { "hint-id": uploaderId }, hint) : null, errorMessage ? (index.h("gcds-error-message", { messageId: uploaderId }, errorMessage)) : null, index.h("div", { key: 'b6987706077db9afa75f38e66afcc2f4ebb32bc8', class: `file-uploader__input ${value.length > 0 ? 'uploaded-files' : ''}`, onDrop: e => this.handleDrop(e), onDragOver: e => e.preventDefault() }, index.h("button", { key: 'a6feb4b86f3b6cc7fd9998bc3179f043e7f64365', type: "button", tabindex: "-1", onClick: () => this.shadowElement.click() }, I18N$h[lang].button.upload), index.h("input", Object.assign({ key: '7d730c993cef70cd1dac600a58e5acef40bdfabd', type: "file", id: uploaderId }, attrsInput, { onBlur: () => this.onBlur(), onFocus: () => this.gcdsFocus.emit(), onInput: e => this.handleInput(e, this.gcdsInput), onChange: e => this.handleInput(e, this.gcdsChange), "aria-invalid": hasError ? 'true' : 'false', ref: element => (this.shadowElement = element) })), value.length > 0 ? (index.h("gcds-sr-only", { id: "file-uploader__summary" }, index.h("span", null, I18N$h[lang].summary.selected, " "), value.map(file => (index.h("span", null, file, " "))))) : (index.h("gcds-sr-only", { id: "file-uploader__summary" }, I18N$h[lang].summary.unselected))), value.length > 0
            ? value.map(file => (index.h("div", { class: "file-uploader__uploaded-file", "aria-label": `${I18N$h[lang].removeFile} ${file}.` }, index.h("gcds-text", { "margin-bottom": "0" }, file), index.h("button", { onClick: e => this.removeFile(e) }, index.h("span", null, I18N$h[lang].button.remove), index.h("gcds-icon", { name: "close", size: "text", "margin-left": "150" })))))
            : null)));
    }
    static get delegatesFocus() { return true; }
    static get formAssociated() { return true; }
...
const GcdsFooter = class {
    ...
    render() {
        ...
        let subLinkCount = 0;
        return (index.h(index.Host, { key: '6a0f9c4059caa2e30ef02a4bb51a552152c2bc4e', role: "contentinfo", "aria-label": "Footer" }, index.h("gcds-sr-only", { key: 'c6303a1cec09909530a3301fa5e5b2ef991a41d1', tag: "h2" }, I18N$g[lang].about), contextualLinksObject && contextualHeading && (index.h("div", { key: '07b21b1d7d83972f74c8bb0ab78a9e54f84c87eb', class: "gcds-footer__contextual" }, index.h("div", { key: '64417ee815a86dbf4871972bcfd138721dfdc497', class: "contextual__container" }, index.h("nav", { key: '4de71bc121ab044532922ce8e21278dc2d9329df', "aria-labelledby": "contextual__heading" }, index.h("h3", { key: '1ddcfa84c72e86ffb9c1558988dbc70c940e6c98', id: "contextual__heading", class: "contextual__heading" }, contextualHeading), index.h("ul", { key: '10f038c6286ca9e9e0ec1892797bd22d5cd7c1cf', class: "contextual__list" }, Object.keys(contextualLinksObject).map(key => {
            if (contextualLinkCount < 3) {
                contextualLinkCount++;
                return (index.h("li", null, index.h("gcds-link", { size: "small", href: contextualLinksObject[key] }, key)));
            }
        })))))), display === 'full' ? (index.h("div", { class: "gcds-footer__main" }, index.h("div", { class: "main__container" }, index.h("nav", { class: "main__govnav", "aria-labelledby": "govnav__heading" }, index.h("h3", { id: "govnav__heading" }, I18N$g[lang].gov.heading), index.h("ul", { class: "govnav__list" }, Object.keys(govNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: govNav[value].link }, govNav[value].text)))))), index.h("nav", { class: "main__themenav", "aria-labelledby": "themenav__heading" }, index.h("gcds-sr-only", { tag: "h4", id: "themenav__heading" }, I18N$g[lang].themes.heading), index.h("ul", { class: "themenav__list" }, Object.keys(themeNav).map(value => (index.h("li", null, index.h("gcds-link", { size: "small", href: themeNav[value].link }, themeNav[value].text))))))))) : null, index.h("div", { key: '4909ad3592fd2304df8353e11947eca69aaa56aa', class: "gcds-footer__sub" }, index.h("div", { key: '3c4d3282dd8ead4b87df28591d94d6e6d327ef8d', class: "sub__container" }, index.h("nav", { key: 'ee1baa7d6ea78245af3451f128182683b51649a8', "aria-labelledby": "sub__heading" }, index.h("gcds-sr-only", { key: 'fa65fa21472446b67ea15179f27394ff95f238bf', tag: "h3", id: "sub__heading" }, I18N$g[lang].site.heading), index.h("ul", { key: '630f20304416893db2c67a6cda4400205a822a4b' }, subLinks
...
const GcdsHeader = class {
    ...
    get renderSkipToNav() {
        if (this.el.querySelector('[slot="skip-to-nav"]')) {
            ...
            return (index.h("nav", { class: "gcds-header__skip-to-nav", "aria-label": I18N$e[this.lang].skipLabel }, index.h("gcds-link", { href: this.skipToHref }, I18N$e[this.lang].skip)));
        }
        else {
            return;
        }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e13f9438f4b30aee0de9c97c7fbce2e80d3ee1ff', role: "banner" }, renderSkipToNav, hasBanner ? index.h("slot", { name: "banner" }) : null, index.h("div", { key: 'cb78ebfcfc947c038c8adb21c5242e11f6f4ebaf', class: "gcds-header__brand" }, index.h("div", { key: '835349463a8459e9fc423e984e555461d584fde5', class: `brand__container ${!hasSearch ? 'container--simple' : ''}` }, renderToggle, renderSignature, renderSearch)), index.h("slot", { key: 'ccd900088b66a0e031f14afc2402284ed9e3988a', name: "menu" }), hasBreadcrumb ? (index.h("div", { class: "gcds-header__container" }, index.h("slot", { name: "breadcrumb" }))) : null));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsHeading = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (index.h(index.Host, { key: '5d6d74358f199427e5c9994d9c7a7b472d11a911' }, index.h(Tag, { key: 'af7503ae216fa3ee40bdac28e0323c0f877946bd', class: `
            gcds-heading
            ${headingRole ? `role-${headingRole}` : ''}
            ${characterLimit ? 'limit' : ''}
            ${marginTop ? `mt-${marginTop}` : ''}
            ${marginBottom ? `mb-${marginBottom}` : ''}
          ` }, index.h("slot", { key: '2b60752a725f01335d1885d97409175462dc173d' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "tag": ["validateTag"],
...
const GcdsHint = class {
    ...
    render() {
        const { hintId } = this;
        return (index.h(index.Host, { key: '43409b1e4ecafb39638dc4ce60ba021024737559', id: `hint-${hintId}` }, index.h("gcds-text", { key: '4681f54c9870c6eacc680bf3e4b1fce706d4aa59', class: "gcds-hint", "margin-bottom": "0", part: "hint" }, index.h("slot", { key: '2c5b966609edebec1090969cc9e02b13205aadfb' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsIcon = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'acfcce1cb6a96e3f96c95c19e8a06ffa91be2306' }, index.h("span", { key: '97dd8217a134541eb55ad6addc1b1fb3e9872790', class: `
...
const GcdsLabel = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '37a6681d7fed70d37313a5d93d5d61de1502e538', id: `label-for-${labelFor}` }, index.h("label", { key: '1ce8e12182daeeff2d47e667028c735c9bab44e3', htmlFor: labelFor, class: `gcds-label ${hideLabel ? 'label--hidden' : ''}` }, index.h("span", { key: '5883396a2787821cf582b66bf21e6553fcc2641e' }, label), required ? (index.h("span", { "aria-hidden": "true", class: "label--required" }, "(", I18N$c[lang].required, ")")) : null)));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsLangToggle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '62aa9c22bff1a0f8778c5835f7e63646cbfe1a46' }, index.h("div", { key: '88d41598195886ac785f5892a98b21b4ec6305a1', class: "gcds-lang-toggle" }, index.h("gcds-sr-only", { key: '6237c11ac97300f34d12b1514353715ff08cc3c7', id: "lang-toggle__heading", tag: "h2" }, I18N$b[lang].heading), index.h("gcds-link", { key: 'd71e4738bf386fce9bd917c7ebad9996e668c109', size: "regular", href: href, lang: I18N$b[lang].abbreviation }, index.h("span", { key: 'ad354cf5d68967abc49af62bd13dcb403f1247b0' }, I18N$b[lang].language), index.h("abbr", { key: '5d4d1a9b12e51c2fdb1740aea1d0a237b926ba85', title: I18N$b[lang].language }, I18N$b[lang].abbreviation)))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsLink = class {
    ...
    getIcon() {
        ...
        if (isExternal) {
            return index.h("gcds-icon", { name: "external", label: I18N$a[lang].external });
        }
        if (download !== undefined) {
            return index.h("gcds-icon", { name: "download", label: I18N$a[lang].download });
        }
        if (href === null || href === void 0 ? void 0 : href.toLowerCase().startsWith('mailto:')) {
            return index.h("gcds-icon", { name: "email", label: I18N$a[lang].email });
        }
        if (href === null || href === void 0 ? void 0 : href.toLowerCase().startsWith('tel:')) {
            return index.h("gcds-icon", { name: "phone", label: I18N$a[lang].phone });
        }
        return null;
    }
    render() {
        ...
        const isExternal = target === '_blank' || external;
        return (index.h(index.Host, { key: '7fa892f419ed82d2218a8166cb9df9087309f049' }, index.h("a", Object.assign({ key: '1b771e086f262c942e89359aab40a242cdeca8e7', tabIndex: 0 }, attrs, { class: `gcds-link link--${size} ${display != 'inline' ? `d-${display}` : ''} ${linkRole != 'default' ? `role-${linkRole}` : ''}`, ref: element => (this.shadowElement = element), target: isExternal ? '_blank' : target, rel: isExternal ? 'noopener noreferrer' : rel }, inheritedAttributes, { part: "link", onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => utils.emitEvent(e, this.gcdsClick, href) }), index.h("slot", { key: '86a797523cf073c1e75e3adfb224ff10f8344a76' }), this.getIcon() && (index.h("span", { key: '61a96d99ba2782a0853bdc7d4dff5a4a250f8858', class: "text-icon-group" }, "\u00A0", this.getIcon())))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsNavGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '159a59d35c9f64a266d942fb9a57ba9973c6b968', role: "listitem", open: open }, index.h("div", { key: '90f518b5fcfed0ae7a7574eb153651a6915a9b64', class: "gcds-nav-group__container" }, index.h("button", { key: '3c95cf1d6787abdd1ee1ef924579cd03c175409d', "aria-haspopup": "true", tabIndex: 0, "aria-expanded": open.toString(), ref: element => (this.triggerElement = element), class: `gcds-nav-group__trigger gcds-trigger--${this.navStyle}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => {
                const event = utils.emitEvent(e, this.gcdsClick);
                if (event) {
                    this.toggleNav();
                }
            } }, index.h("gcds-icon", { key: 'c533dfb1c4393a3453b53b7e7353c01adaf582e4', name: this.navStyle === 'expandable'
                ? open
                    ? 'chevron-down'
                    : 'chevron-right'
                : open
                    ? 'chevron-up'
                    : 'chevron-down' }), closeTrigger && open ? closeTrigger : openTrigger), index.h("ul", { key: '5a5395d27b0f6c39a63c1605a0112f0c27d6a678', "aria-label": menuLabel, class: `gcds-nav-group__list gcds-nav--${this.navStyle}` }, index.h("slot", { key: '68763c8422c0ee0d0d28b5b4a6ad680682156d58' })))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNavLink = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a6e2fa48b4b77a616dc53e40bc118cd919cf8ac2', role: "listitem" }, index.h("a", Object.assign({ key: '2f7e253d103f1c87c7b4450f879288705cdf0795', class: `gcds-nav-link gcds-nav-link--${this.navStyle}`, href: href }, linkAttrs, { tabIndex: 0, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => utils.emitEvent(e, this.gcdsClick, href), ref: element => (this.linkElement = element) }), index.h("slot", { key: 'fa0abad92cfc665af35535215fb259477c3b704a' }))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsNotice = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '03e09c9feca750421af5461d3530a3b459f8c0a1' }, this.validateRequiredProps() && (index.h("section", { key: 'a662553fe15c9b04690a5fa3b5904d7c8f04ebcf', class: `gcds-notice notice--role-${noticeRole}` }, index.h("gcds-icon", { key: '710bf5e2c0eddf52f765d1247b79147139a57f44', class: "notice__icon", size: "h4", name: iconRoles[noticeRole] }), index.h("div", { key: '148dc06af3014b33b0180865839cf920b18aabdd' }, index.h("gcds-heading", { key: '7f9c4947154fc5ecf7cf7023968da3d5e7c48c46', tag: noticeTitleTag, "margin-top": "0", "margin-bottom": "100", class: "notice__heading" }, index.h("gcds-sr-only", { key: 'f954a5fd1b3846dfe82e69be40eac77cc10a363a', tag: "span" }, I18N$9[this.lang][noticeRole]), noticeTitle), index.h("slot", { key: 'ac208cbe2c085f09358cd043b5a925b881d21300' }))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsPagination = class {
    ...
    configurePaginationStep(page, end, mobile) {
        ...
        if (end) {
            return (index.h("li", { class: `list-btn-${end === 'next' ? 'next' : 'prev'}` }, end === 'next' ? (index.h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ...
                    : 'gcds-pagination-end-button-mobile' }), index.h("span", null, I18N$8[this.lang].listNext), index.h("gcds-icon", { "margin-left": "150", name: "chevron-right" }))) : (index.h("a", Object.assign({}, linkAttrs, { class: !mobile
                    ? 'gcds-pagination-end-button'
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5a22bb8478a48910d4c4704e396287597126291e', role: "navigation", "aria-label": label }, index.h("div", { key: 'b0a03a138b2c7b83eb77a4c05b18b80179a2ee21', class: "gcds-pagination" }, display === 'list' ? (index.h("div", null, index.h("ul", { class: "gcds-pagination-list" }, this.listitems), index.h("ul", { class: "gcds-pagination-list-mobile-prevnext" }, this.mobilePrevNext))) : (index.h("ul", { class: "gcds-pagination-simple" }, previousHref && (index.h("li", { class: "gcds-pagination-simple-listitem" }, index.h("a", { href: previousHref, tabindex: 0, "aria-label": `${I18N$8[lang].previousPage}${previousLabel ? `: ${previousLabel}` : ''}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => utils.emitEvent(e, this.gcdsClick, previousHref) }, index.h("gcds-icon", { "margin-right": "150", name: "chevron-left", size: "h6" }), index.h("div", { class: "gcds-pagination-simple-text" }, I18N$8[lang].previous), index.h("span", null, previousLabel)))), nextHref && (index.h("li", { class: "gcds-pagination-simple-listitem" }, index.h("a", { href: nextHref, tabindex: 0, "aria-label": `${I18N$8[lang].nextPage}${nextLabel ? `: ${nextLabel}` : ''}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: e => utils.emitEvent(e, this.gcdsClick, nextHref) }, index.h("gcds-icon", { "margin-right": "150", name: "chevron-right", size: "h6" }), index.h("div", { class: "gcds-pagination-simple-text" }, I18N$8[lang].next), index.h("span", null, nextLabel)))))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsSearch = class {
    ...
    render() {
        ...
        const formAction = action === '/sr/srb.html'
            ...
            : action;
        return (index.h(index.Host, { key: '351c19e77ee62b5206c951394a314db289c3db49' }, index.h("section", { key: '0d9cc7c5371afb4cc29eb0d8f3fb3d9dc706d343', class: "gcds-search" }, index.h("gcds-sr-only", { key: 'dfc2372361bdf8fd155f3171d24875c03c56e50e', tag: "h2" }, I18N$6[lang].search), index.h("form", { key: 'f56f87af7732a18c62478e5cf3094d8ab17ee4b6', action: formAction, method: method, role: "search", onSubmit: e => utils.emitEvent(e, this.gcdsSubmit, this.value), class: "gcds-search__form" }, index.h("gcds-label", { key: '85cec480928ce03a339dd7651af655a2d567155c', label: labelText, "label-for": searchId, "hide-label": true }), index.h("input", Object.assign({ key: '1ff9200998cd3cdf542e3ec0cd549c2c7dd02b68', type: "search", id: searchId }, (suggestedArray ? { list: 'search-list' } : {}), { size: 35, maxLength: 170, onInput: e => this.handleInput(e, this.gcdsInput), onChange: e => this.handleInput(e, this.gcdsChange), onFocus: () => this.gcdsFocus.emit(), onBlur: () => this.gcdsBlur.emit() }, attrsInput, { class: "gcds-search__input", value: value })), suggestedArray && (index.h("datalist", { key: 'ff7ab30e2ed34a19ee8ca6e1c349cba075181ad7', id: "search-list" }, suggestedArray.map((k, v) => (index.h("option", { value: k, key: v }))))), index.h("gcds-button", { key: '85cd54e3279d2a502711749eb32769ced733fa7a', type: "submit", class: "gcds-search__button", exportparts: "button" }, index.h("gcds-icon", { key: 'b32768c407f925990fae8ba60a719a7f7a7af218', name: "search", label: I18N$6[lang].search, size: "h3" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsSideNav = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f442cae66ab5b6c7b82299647ffa270a88cfd3bf' }, index.h("nav", { key: '0e8fa9b596ac27b198851f5b6f7d56e277ac82e8', "aria-label": `${label}${I18N$5[lang].navLabel}`, class: "gcds-side-nav" }, index.h("ul", { key: '2ced3163911bf5007a03a83e3b6c03e13e74a2ba' }, index.h("gcds-nav-group", { key: '412ce1205e32cc0c01b381134a21afbdb0ab5d14', menuLabel: I18N$5[lang].menuLabel, closeTrigger: I18N$5[lang].closeTrigger, openTrigger: I18N$5[lang].menuLabel, class: "gcds-mobile-nav", ref: element => (this.mobile = element), lang: lang }, index.h("slot", { key: '59405925a392b28a8397ba62018d805a990cca31', name: "home" }, index.h("li", { key: '04a61dced77e6f0cbd09a102606e69f0bb1f0ed8', class: "gcds-side-nav__heading" }, label)), index.h("slot", { key: 'efce195284a2be15e5f1e19c8e20d3fd02515980' }))))));
    }
    get el() { return index.getElement(this); }
};
...
const GcdsSignature = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '94eec887a2b356422e39f24658ccf9a8352b533e' }, type === 'signature' ? (index.h(Tag, Object.assign({}, sigAttrs), index.h("div", { innerHTML: selectSVG }), index.h("gcds-sr-only", { tag: "span", lang: lang === 'en' ? 'fr' : 'en' }, lang === 'en'
            ? `/ ${I18N$4.fr.gc}`
            : `/ ${I18N$4.en.gc}`))) : (index.h("div", { class: "gcds-signature", innerHTML: selectSVG }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "type": ["validateType"],
...
const GcdsSrOnly = class {
    ...
    render() {
        const Tag = this.tag;
        return (index.h(index.Host, { key: '3383ec4736158a1272001467347592c58d1d125b' }, index.h(Tag, { key: '30db2f8f3c3715b31330f6fbbce8b5ad87481a65' }, index.h("slot", { key: '4df7666a95decef3d6a53e410c3236a1a40f8dd2' }))));
    }
    static get watchers() { return {
        "tag": ["validateTag"]
    }; }
...
const GcdsStepper = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3e35d92b373461bf3c3135724d02bf2009c0a6a6' }, this.validateRequiredProps() && (index.h("gcds-heading", { key: '5d7485c25354ee819f4a62ecaef6cb27bc767730', tag: tag, class: "gcds-stepper", "margin-top": "0", "margin-bottom": "225" }, index.h("span", { key: 'aa98533dd70df383a094f40217e6ad13aca4236d', class: "gcds-stepper__steps" }, `${I18N$3[lang].step} ${currentStep} ${I18N$3[lang].of} ${totalSteps}`, index.h("gcds-sr-only", { key: '62ee5dd0528b52535a35c8c46e3fd716f4b196d1' }, " : ")), index.h("slot", { key: 'cc168422742cd8e335fc068a97969ef074b14034' })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const renderSortRadios = (element) => {
    ...
    return (index.h("gcds-radios", { class: "gcds-table__modal-sort", legend: I18N$2[lang].sort, name: "sort", autoFocus: true, options: radioOptions, value: isSorted, ref: el => (element.sortRadios = el) }));
};
    ...
    return (index.h("div", { class: "gcds-table__filters" },
        index.h("gcds-button", { size: "small", buttonRole: "primary", onClick: () => element.filterSortModal.showModal() },
            ...
            filterValue && (index.h(index.Fragment, null,
                ...
                index.h("span", { class: "gcds-table__active-count", "aria-label": `${I18N$2[lang].activeBadgeLabel.replace('{count}', 1)}` }, "1")))),
        index.h("dialog", { class: "gcds-table__modal", "aria-modal": "true", "aria-labelledby": "gcds-table__modal-heading", ref: el => (element.filterSortModal = el) },
            index.h("div", { class: "gcds-table__modal-header" },
                index.h("gcds-heading", { tag: "h2", id: "gcds-table__modal-heading", marginTop: "0", marginBottom: "0" }, I18N$2[lang].filterAndSort),
                index.h("gcds-button", { "button-role": "secondary", onClick: () => {
            ...
            index.h("form", { class: "gcds-table__modal-body", onSubmit: ev => {
                    ev.preventDefault();
                    if (element.filter) {
                ...
                index.h("div", { class: "gcds-table__modal-content" },
                    element.filter && (index.h("gcds-input", { class: "gcds-table__modal-filter", type: "search", label: I18N$2[lang].filterLabel, name: "filter", inputId: "gcds-table-filter", autoFocus: true, value: filterValue, ref: el => (element.filterInput = el) })),
                    element.sortEnabled() && renderSortRadios(element)),
                index.h("div", { class: "gcds-table__modal-footer" },
                    index.h("gcds-button", { "button-role": "secondary", onClick: () => {
                            if (element.filter) {
                                element.filterInput.value = element.initialFilter;
                            }
                    ...
                    index.h("gcds-button", { "button-role": "primary", type: "submit" }, I18N$2[lang].modalApplyButton))))));
};
const renderFilterPills = (filterValue, lang, onRemove) => {
    if (!filterValue)
        return null;
    return (index.h("div", { class: "gcds-table__active-filter" },
        index.h("button", { class: "gcds-table__pill", onClick: onRemove, title: I18N$2[lang].pillRemoveFilter },
            index.h("gcds-sr-only", { tag: "span" }, I18N$2[lang].pillFilter),
            filterValue,
            index.h("gcds-icon", { name: "close", size: "text-small" }))));
};
const renderSortPills = (sorting, table, lang, onRemove) => {
    if ((sorting === null || sorting === void 0 ? void 0 : sorting.length) === 0)
        return null;
    return (index.h("div", { class: "gcds-table__active-sorting" },
        index.h("span", { class: "gcds-table__sort-label" }, I18N$2[lang].pillSort), sorting === null || sorting === void 0 ? void 0 :
        sorting.map(sort => {
            const column = table.getColumn(sort.id);
            if (!column)
                return null;
            return (index.h("button", { class: "gcds-table__pill", onClick: () => onRemove(column.id), title: I18N$2[lang].pillRemoveSort },
...
const GcdsTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("section", { class: "gcds-table" }, (this.filter || this.sortEnabled()) && renderFilterSortModal(this), index.h("div", { class: "gcds-table__active-pills" }, renderFilterPills(this.filterValue, this.lang, () => {
            this.filterValue = '';
            updateTableOptions(this);
        }), renderSortPills(this.sorting, this.table, this.lang, (columnId) => {
            this.sorting = this.sorting.filter(s => s.id !== columnId);
            updateTableOptions(this);
        })), index.h("div", { class: "gcds-table__row-management" }, this.pagination && (index.h("div", { class: "gcds-table__page-size" }, index.h("gcds-select", { label: I18N$2[this.lang].rowsPerPage, name: "page-size", selectId: "gcds-table-page-size", value: this.paginationSize.toString(), onChange: e => this.handlePageSizeSelect(e) }, this.paginationSizeOptions.map(opt => (index.h("option", { key: opt, value: opt }, opt === 0 ? 'All' : opt)))))), index.h("span", { class: "gcds-table__page-info", role: "status", "aria-live": "polite" }, renderTableStatus(this.el, this.table, this.paginationState, this.lang))), index.h("table", { class: "gcds-table__table", tabindex: "-1", ref: el => {
                if (el)
                    this.shadowElement = el;
            } }, this.el.querySelector('[slot="caption"]') && (index.h("caption", null, index.h("slot", { name: "caption" }))), index.h("thead", null, headerGroups.map(hg => (index.h("tr", { key: hg.id }, hg.headers.map(header => {
            var _a;
            ...
            return (index.h("th", { key: header.id, class: `gcds-table__th ${alignmentClass}`, scope: "col", "aria-sort": header.column.getIsSorted() === 'asc'
                ...
                colDef.header, index.h("span", { class: "gcds-table__sort-icon", "aria-hidden": "true" }, getSortIcon(header.column)))) : (colDef === null || colDef === void 0 ? void 0 : colDef.header)));
        }))))), index.h("tbody", null, rows.length === 0 ? (index.h("tr", null, index.h("td", { class: "gcds-table__empty", colSpan: ((_a = this.columns) !== null && _a !== void 0 ? _a : []).length }, I18N$2[this.lang].noData))) : (rows.map(row => (index.h("tr", { key: row.id, class: "gcds-table__row" }, row.getVisibleCells().map(cell => {
            var _a, _b;
            ...
            cellContent = !isSlotted
                ...
                : null;
            return (index.h(Tag, Object.assign({ key: cell.id, class: `gcds-table__td${(colDef === null || colDef === void 0 ? void 0 : colDef.alignment) ? ` alignment-${colDef.alignment}` : ''}`, "data-column": colDef === null || colDef === void 0 ? void 0 : colDef.header, "data-cell": `${cell.column.id}-${row.id}`, ref: isSlotted && !isManaged
                    ? tdEl => this.mountSlottedCell(tdEl, cell.column.id, row.original, Number(row.id))
                    : undefined }, scope), cellContent));
        }))))))), this.pagination && this.paginationSize !== 0 && (index.h("gcds-pagination", { display: "list", currentPage: this.paginationState.pageIndex + 1, totalPages: this.table.getPageCount(), label: I18N$2[this.lang].paginationLabel, onGcdsClick: e => this.handlePaginationClick(e) }))), index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const GcdsText = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '648db92f3454dab29f6a3fdb33e282b6268cc82b', class: `${display != 'block' ? `d-${display}` : ''}` }, index.h("p", { key: '01045b0b67c9c5f1ea9ce19ebaa7d80ad2668ca0', class: `
            gcds-text
...
const GcdsTextarea = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4c93c2645ce5374794cac263a3206ee8cc2ed1f5' }, index.h("div", { key: 'c9c7c6b5b5f26e2c1c1e451ae64f478746b18e21', class: `gcds-textarea-wrapper ${disabled ? 'gcds-disabled' : ''} ${hasError ? 'gcds-error' : ''}` }, index.h("gcds-label", Object.assign({ key: '43a9fed50882d577a2fbeb50519d233ef069b94c' }, attrsLabel, { "hide-label": hideLabel, "label-for": textareaId, lang: lang })), hint ? index.h("gcds-hint", { "hint-id": textareaId }, hint) : null, errorMessage ? (index.h("gcds-error-message", { messageId: textareaId }, errorMessage)) : null, index.h("textarea", Object.assign({ key: '80d8daf6be299b6dd933842182e507ba119ad651' }, attrsTextarea, { class: hasError ? 'gcds-error' : null, id: textareaId, onBlur: () => this.onBlur(), onFocus: () => this.onFocus(), onInput: e => this.handleInput(e, this.gcdsInput), onChange: e => this.handleInput(e, this.gcdsChange), "aria-labelledby": `label-for-${textareaId}`, "aria-invalid": errorMessage ? 'true' : 'false', style: cols ? style : null, ref: element => (this.shadowElement = element) }), value), maxlength ? (index.h(index.Fragment, null, index.h("gcds-sr-only", { tag: "span", id: `textarea__count-${textareaId}` }, I18N$1[lang].characters.maxlength.replace('{{num}}', maxlength)), !hideLimit && (index.h("gcds-text", { id: `textarea__visual-count-${textareaId}`, "aria-hidden": "true" }, I18N$1[lang].characters.left, value == undefined ? maxlength : maxlength - value.length)), index.h("gcds-sr-only", { tag: "span" }, index.h("span", { id: `textarea__sr-count-${textareaId}`, role: "status", "aria-atomic": "true" })))) : null)));
    }
    static get delegatesFocus() { return true; }
    static get formAssociated() { return true; }
    get el() { return index.getElement(this); }
...
const GcdsTopNav = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8d59384709deb49ab45df787053bb8984db783ff' }, index.h("div", { key: 'b0f1bbbde13877522bc3221519ddf248a7a2f332', class: "gcds-top-nav" }, index.h("nav", { key: '34a0d7c4b66f34e8527fa8c1687e85e259f5f79e', "aria-label": `${label}${I18N[lang].navLabel}` }, index.h("ul", { key: 'f48641ec799bc5d73de6a32f7e671b224a315262', class: "gcds-top-nav__container" }, index.h("gcds-nav-group", { key: 'feccca515b89c8dfa0e93a100d077db20bcf5e5e', menuLabel: I18N[lang].menuLabel, closeTrigger: I18N[lang].closeTrigger, openTrigger: I18N[lang].menuLabel, class: "gcds-mobile-nav gcds-mobile-nav-topnav", ref: element => (this.mobile = element), lang: lang }, index.h("slot", { key: '0eae3974ebce3d5ce961e6e21f4eee3d7d99b512', name: "home" }), index.h("li", { key: 'dcdbda307ffadd1d454f07f310dd421b186c686e', class: `nav-container__list nav-list--${alignment}` }, index.h("ul", { key: '164e125696131ee497fd098f92fdd8fe92200372', class: `nav-container__list nav-list--${alignment}` }, index.h("slot", { key: '095f6aab8a072f72b920bb26cc2c033e9358dc1b' })))))))));
    }
    get el() { return index.getElement(this); }
};
